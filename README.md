...
| 난이도 | 레벨 | 특징 |
|--------|------|------|
| EASY | Lv.4 | 탭+홀드 중심, 가끔 플릭 |
| NORMAL | Lv.7 | 동시치기 입문, 본격 밀도 |
| HARD | Lv.10 | 동시치기+연타 |
| EXPERT | Lv.14 | 고속 연타+동시치기 |
...
| 자켓 | 곡명 | 분위기 | BPM |
|------|------|--------|-----|
| 🌿 | 1번도로 (적·녹) | Route 1 | 112 |
| 💤 | 포켓몬센터 (적·녹) | Heal | 84 |
| 🔥 | VS 체육관 관장 (적·녹) | Gym Leader | 152 |
| ⚡ | VS 라이벌 (적·녹) | Rival | 128 |
| 🌊 | 19번수로 파도타기 (적·녹) | Surf | 120 |
| 🌙 | 달맞이산 (적·녹) | Mt. Moon | 72 |
| 🏆 | VS 챔피언 (적·녹) | Champion | 160 |
| 🕶 | 로켓단 아지트 (적·녹) | Rocket Hideout | 132 |
| 🌆 | 금빛시티 (금·은) | Goldenrod | 124 |
